...
#########################################################
# Arguments:
# $1 = protozoaDB. File with the reference genome for the mapping. Contains the references.
...
# Output files: (In ANALYSIS/sampleName/06.protozoa/)
# sampleName_xx_protozoa_mapped.sam: SAM file from mapping the processed files against xx reference genome.
# sampleName_xx_protozoa_R1.fastq: .fastq file with R1 reads that mapped the protozoa xx DB.
# sampleName_xx_protozoa_R2.fastq: .fastq file with R2 reads that mapped the protozoaetria xx DB.
# sampleName_xx_protozoa_mapping.log: .log file with a log of the mapping of xx DB.
