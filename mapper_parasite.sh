...
# sampleName_organism_mapped.sam: SAM file from mapping the processed files against reference genome.
# sampleName_organism_mapped.bam: BAM file from mapping the processed files against reference genome.
# sampleName_organism_R1.fastq: .fastq file with R1 reads that mapped the organism DB.
