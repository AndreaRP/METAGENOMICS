...
bac16SDB="${bacDB}16S/bowtie2/16S"
...
#		OutputFiles: 16S
bowtie2logFile16S="${bacFilesDir}${sampleName}_16S_bacteria_mapping.log"
BacMappedR116SFastq="${bacFilesDir}${sampleName}_16S_Bacteria_R1.fastq"
BacMappedR216SFastq="${bacFilesDir}${sampleName}_16S_Bacteria_R2.fastq"
mappedSam16SFile="${bacFilesDir}${sampleName}_16S_bacteria_mapped.sam"
#		OutputFiles: Whole Genome (WG)
bowtie2logFileWG="${bacFilesDir}${sampleName}_WG_bacteria_mapping.log"
BacMappedR1WGFastq="${bacFilesDir}${sampleName}_WG_Bacteria_R1.fastq"
BacMappedR2WGFastq="${bacFilesDir}${sampleName}_WG_Bacteria_R2.fastq"
mappedSamWGFile="${bacFilesDir}${sampleName}_WG_bacteria_mapped.sam"
