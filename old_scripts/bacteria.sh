...
sampleBacDir="${workingDir}ANALYSIS/05-bacteria/${sampleName}/"
#bacteriaDir="${sampleAnalysisDir}/03.BACTERIA/"
sampleAnalysisLog="${sampleBacDir}/${sampleName}_lablog.log"  
...
echo -e " Execute map_bacteria $bacDB $sampleName" >> "${sampleAnalysisLog}"
map_bacteria $bacDB $sampleName
...
coverage.sh $sampleBacDir $bacDB
