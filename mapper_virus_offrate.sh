...
#		Constants
virDBDir="${virDB}/WG/bwt2_offrate/virus_offrate"
sampleName=$(basename "${sampleDir}")
workingDir="/processing_Data/bioinformatics/research/20160530_METAGENOMICS_AR_IC_T/"
virFilesDir="${workingDir}/ANALYSIS/06-virus/${sampleName}/reads/offrate/" #directory where the host filtering files will we saved (sam for mapping and fastq for host free samples)
noHostDir="${workingDir}/ANALYSIS/04-noHost/${sampleName}/" #directory where the host free reads are
